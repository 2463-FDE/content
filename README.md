...
Fresh credential-free browser evidence covers 320 px and desktop layouts: maximum-length labels, a sparse Wednesday assignment and accessibility snapshot, measured light/dark week-label contrast, nullable colors, dotted and hostile hrefs, and a synthetically blocked loader asset. Results are recorded in `tests/evidence/curriculum-correction-browser.txt`.

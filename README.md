...
Fresh credential-free browser evidence at 320 px — maximum-length labels, a one-unit assigned response, nullable colors across all availability states, dotted and hostile hrefs, and a synthetically blocked loader asset — is recorded in `tests/evidence/curriculum-correction-browser.txt`.

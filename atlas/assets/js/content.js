      ...
      },
      {
        ...
        deeper: [
          ...
          },
          {
            ...
            body: "<p>Architecture diagram, parameters, and &ldquo;here is where we are&rdquo; walkthroughs. Session 1 calls this the stage with the most iteration alongside source analysis.</p><p><strong>Naming note.</strong> Archit never names this as a numbered step. Session 1 jumps straight from step 2 to step 4 &mdash; <em>&ldquo;once this step two and step four, you can see actually. So step four, in particular, is the implementation specs generation&rdquo;</em> &mdash; while describing the walkthrough checkpoints that sit between them. This Atlas names the step, because the walkthrough plainly happens and an unnamed stage is harder to learn than a named one. [[VIMEO]][[VIMEO2]]</p>"
          },
          {
